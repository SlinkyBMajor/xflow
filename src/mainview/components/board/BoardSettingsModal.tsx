	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="bg-[#161b22] border-[#30363d] text-[#e6edf3] max-w-md">
				<DialogHeader>
					<DialogTitle className="text-[#e6edf3]">Board Settings</DialogTitle>
				</DialogHeader>
				...
				<div className="space-y-4 py-2">
					<div className="space-y-3">
						...
						{worktreeEnabled && (
							<>
								<div>
									<Label className="text-xs text-[#8b949e] mb-1">Default merge strategy</Label>
									<select
										value={mergeStrategy}
								...
								<div>
									<Label className="text-xs text-[#8b949e] mb-1">Default base branch</Label>
									<Input
										value={baseBranch}
